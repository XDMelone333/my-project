  ...
  <div>
    <v-app id="inspire">
      ...
      >
        ...
        <v-img
            height="250"
            src="https://www.eventim-light.com/de/api/image/5fb790f208559a0a31c427bb/shop_preview/webp"
        ></v-img>
        <v-card-title>Wohl bekloppt geworden</v-card-title>
        <p class="my-0 text-subtitle-1"></p>
